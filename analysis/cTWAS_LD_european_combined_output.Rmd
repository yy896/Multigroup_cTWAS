...
LD_dir <- "~/Desktop/Prostate Cancer Project/LD_b38"
genome_version <- "b38"
...
We use the ctwas main function `ctwas_sumstats` to run the cTWAS analysis without LD. For more details on this function, refer to the cTWAS tutorial: https://xinhe-lab.github.io/multigroup_ctwas/articles/running_ctwas_analysis.html
...
make_locusplot(finemap_res,
               region_id = "2_132285211_134401007",
               ens_db = ens_db,
               weights = weights,
               highlight_pip = 0.8,
               filter_protein_coding_genes = TRUE,
