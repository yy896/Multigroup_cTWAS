---
title: "Prostate Cancer ~ Predictdb eQTL&sQTL from Prostate & Testis & Lymphocytes & RefZ expression prostate cohort Chr 1+2+22 TEST RUN"
...
weights <- readRDS(system.file("extdata/project_data", "European.combined_weights_chr1_2_22.RDS", package = "ctwas"))
ctwas_res <- readRDS(system.file("extdata/project_data", "European.combined.ctwas_LD_chrs1_2_22.RDS", package = "ctwas"))
gwas_n <- 726828
finemap_res <- readRDS("~/Desktop/Prostate Cancer Project/European.combined.finemap_res.chr1_2_22.RDS")
susie_alpha_res <- readRDS("~/Desktop/Prostate Cancer Project/European.combined.susie_alpha_res.chr1_2_22.RDS")
...
make_locusplot(finemap_res,
               region_id = "1_206268085_208237019",
               ens_db = ens_db,
               weights = weights,
               highlight_pip = 0.8,
               filter_protein_coding_genes = TRUE,
