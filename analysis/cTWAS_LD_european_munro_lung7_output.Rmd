---
title: "Prostate Cancer ~ Munro 7 lung QTLs"
...
weights <- readRDS(system.file("extdata/project_data", "European.munro_lung7_weights.RDS", package = "ctwas"))
ctwas_res <- readRDS(system.file("extdata/project_data", "European.munro_lung7_weights.ctwas_noLD_allchrs.RDS", package = "ctwas"))
gwas_n <- 726828
finemap_res <- readRDS("~/Desktop/Prostate Cancer Project/European.munro_lung_weights.noLD.finemap_res.RDS")
susie_alpha_res <- readRDS("~/Desktop/Prostate Cancer Project/European.munro_lung_weights.noLD.susie_alpha_res.RDS")
...
weight_files <- c("/project2/xinhe/shared_data/multigroup_ctwas/weights/Munro_alt_polyA_PredictDB/apa_Lung.db",
                  "/project2/xinhe/shared_data/multigroup_ctwas/weights/Munro_alt_stability_PredictDB/Lung.db",
                  "/project2/xinhe/shared_data/multigroup_ctwas/weights/Munro_alt_tss_PredictDB/tss_Lung.db",
                  "/project2/xinhe/shared_data/multigroup_ctwas/weights/Munro_expression_PredictDB/expression_Lung.db",
                  "/project2/xinhe/shared_data/multigroup_ctwas/weights/Munro_isoform_PredictDB/isoform_Lung.db",
                  "/project2/xinhe/shared_data/multigroup_ctwas/weights/Munro_splicing_PredictDB/splicing_Lung.db",
                  "/project2/xinhe/shared_data/multigroup_ctwas/weights/Munro_stability_PredictDB/stability_Lung.db")
...
```{r echo=TRUE, eval=FALSE}
weights_lung_apaQTL <- preprocess_weights(weight_files[1],
                                              region_info,
...
weights_lung_astQTL <- preprocess_weights(weight_files[2],
                                              region_info,
                                              gwas_snp_ids = z_snp$id,
                                              snp_map = snp_map,
                                              LD_map = LD_map,
...
weights_lung_tssQTL <- preprocess_weights(weight_files[3],
                                              region_info,
                                              gwas_snp_ids = z_snp$id,
                                              snp_map = snp_map,
                                              LD_map = LD_map,
...
weights_lung_eQTL <- preprocess_weights(weight_files[4],
                                            region_info,
                                            gwas_snp_ids = z_snp$id,
                                            snp_map = snp_map,
                                            LD_map = LD_map,
...
weights_lung_isoQTL <- preprocess_weights(weight_files[5],
                                              region_info,
                                              gwas_snp_ids = z_snp$id,
                                              snp_map = snp_map,
                                              LD_map = LD_map,
...
weights_lung_sQTL <- preprocess_weights(weight_files[6],
                                            region_info,
                                            gwas_snp_ids = z_snp$id,
                                            snp_map = snp_map,
                                            LD_map = LD_map,
...
weights_lung_stQTL <- preprocess_weights(weight_files[7],
                                             region_info,
                                             gwas_snp_ids = z_snp$id,
                                             snp_map = snp_map,
                                             LD_map = LD_map,
...
make_locusplot(finemap_res,
               region_id = "2_237852338_239030947",
               ens_db = ens_db,
               weights = weights,
               highlight_pip = 0.8,
               filter_protein_coding_genes = TRUE,
...
make_locusplot(finemap_res,
               region_id = "2_101205867_102072305",
               ens_db = ens_db,
               weights = weights,
               highlight_pip = 0.8,
               filter_protein_coding_genes = TRUE,
...
make_locusplot(finemap_res,
               region_id = "18_46719283_48413361",
               ens_db = ens_db,
               weights = weights,
               highlight_pip = 0.8,
               filter_protein_coding_genes = TRUE,
...
make_locusplot(finemap_res,
               region_id = "11_44672249_46984586",
               ens_db = ens_db,
               weights = weights,
               highlight_pip = 0.8,
               filter_protein_coding_genes = TRUE,
