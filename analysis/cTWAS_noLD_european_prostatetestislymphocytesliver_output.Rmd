---
title: "Prostate Cancer ~ Predictdb eQTL&sQTL from Prostate & Testis & Lymphocytes & Liver"
...
weights <- readRDS(system.file("extdata/project_data", "European.prostate_testis_lymphocytes_liver.weights.RDS", package = "ctwas"))
ctwas_res <- readRDS(system.file("extdata/project_data", "European.prostate_testis_lymphocytes_liver.ctwas_noLD_allchrs.RDS", package = "ctwas"))
gwas_n <- 726828
finemap_res <- readRDS("~/Desktop/Prostate Cancer Project/European.prostate_testis_lymphocytes_liver.finemap_res.RDS")
...
make_convergence_plots(param, gwas_n, colors = c("#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00", "#CC79A7", "#999999", "black"))
```
