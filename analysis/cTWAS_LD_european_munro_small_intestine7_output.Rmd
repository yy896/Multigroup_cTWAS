---
title: "Prostate Cancer ~ Munro 7 small intestine QTLs"
...
weights <- readRDS(system.file("extdata/project_data", "European.munro_intestine7_weights.RDS", package = "ctwas"))
ctwas_res <- readRDS(system.file("extdata/project_data", "European.munro_intestine7_weights.ctwas_noLD_allchrs.RDS", package = "ctwas"))
gwas_n <- 726828
finemap_res <- readRDS("~/Desktop/Prostate Cancer Project/European.munro_intestine_weights.noLD.finemap_res.RDS")
susie_alpha_res <- readRDS("~/Desktop/Prostate Cancer Project/European.munro_intestine_weights.noLD.susie_alpha_res.RDS")
