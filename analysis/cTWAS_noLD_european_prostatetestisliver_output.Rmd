---
title: "Prostate Cancer ~ Predictdb eQTL&sQTL from Prostate&Testis&Liver"
...
weights <- readRDS(system.file("extdata/project_data", "European.prostate_testis_liver.weights.RDS", package = "ctwas"))
ctwas_res <- readRDS(system.file("extdata/project_data", "European.prostate_testis_liver.ctwas_noLD_allchrs.RDS", package = "ctwas"))
gwas_n <- 726828
finemap_res <- readRDS("~/Desktop/Prostate Cancer Project/European.prostate_testis_liver.finemap_res.RDS")
