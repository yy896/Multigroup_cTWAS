---
title: "Prostate Cancer ~ Munro 7 whole blood QTLs"
...
weights <- readRDS(system.file("extdata/project_data", "European.munro_whole_blood7_weights.RDS", package = "ctwas"))
ctwas_res <- readRDS(system.file("extdata/project_data", "European.munro_whole_blood7_weights.ctwas_noLD_allchrs.RDS", package = "ctwas"))
gwas_n <- 726828
finemap_res <- readRDS("~/Desktop/Prostate Cancer Project/European.munro_whole_blood_weights.noLD.finemap_res.RDS")
susie_alpha_res <- readRDS("~/Desktop/Prostate Cancer Project/European.munro_whole_blood_weights.noLD.susie_alpha_res.RDS")
...
weight_files <- c("/project2/xinhe/shared_data/multigroup_ctwas/weights/Munro_alt_polyA_PredictDB/apa_Whole_Blood.db",
                  "/project2/xinhe/shared_data/multigroup_ctwas/weights/Munro_alt_stability_PredictDB/Whole_Blood.db",
                  "/project2/xinhe/shared_data/multigroup_ctwas/weights/Munro_alt_tss_PredictDB/tss_Whole_Blood.db",
                  "/project2/xinhe/shared_data/multigroup_ctwas/weights/Munro_expression_PredictDB/expression_Whole_Blood.db",
                  "/project2/xinhe/shared_data/multigroup_ctwas/weights/Munro_isoform_PredictDB/isoform_Whole_Blood.db",
                  "/project2/xinhe/shared_data/multigroup_ctwas/weights/Munro_splicing_PredictDB/splicing_Whole_Blood.db",
                  "/project2/xinhe/shared_data/multigroup_ctwas/weights/Munro_stability_PredictDB/stability_Whole_Blood.db")
...
```{r echo=TRUE, eval=FALSE}
weights_whole_blood_apaQTL <- preprocess_weights(weight_files[1],
                                                  region_info,
...
weights_whole_blood_astQTL <- preprocess_weights(weight_files[2],
                                             region_info,
                                             gwas_snp_ids = z_snp$id,
                                             snp_map = snp_map,
                                             LD_map = LD_map,
...
weights_whole_blood_tssQTL <- preprocess_weights(weight_files[3],
                                              region_info,
                                              gwas_snp_ids = z_snp$id,
                                              snp_map = snp_map,
                                              LD_map = LD_map,
...
weights_whole_blood_eQTL <- preprocess_weights(weight_files[4],
                                            region_info,
                                            gwas_snp_ids = z_snp$id,
                                            snp_map = snp_map,
                                            LD_map = LD_map,
...
weights_whole_blood_isoQTL <- preprocess_weights(weight_files[5],
                                            region_info,
                                            gwas_snp_ids = z_snp$id,
                                            snp_map = snp_map,
                                            LD_map = LD_map,
...
weights_whole_blood_sQTL <- preprocess_weights(weight_files[6],
                                             region_info,
                                             gwas_snp_ids = z_snp$id,
                                             snp_map = snp_map,
                                             LD_map = LD_map,
...
weights_whole_blood_stQTL <- preprocess_weights(weight_files[7],
                                              region_info,
                                              gwas_snp_ids = z_snp$id,
                                              snp_map = snp_map,
                                              LD_map = LD_map,
...
weights <- c(
  weights_whole_blood_apaQTL,
  weights_whole_blood_astQTL,
  weights_whole_blood_tssQTL,
  weights_whole_blood_eQTL,
  weights_whole_blood_isoQTL,
  weights_whole_blood_sQTL,
  weights_whole_blood_stQTL)
```
...
make_locusplot(finemap_res,
               region_id = "10_102620653_104935290",
               ens_db = ens_db,
               weights = weights,
               highlight_pip = 0.8,
               filter_protein_coding_genes = TRUE,
