...
```{r GO enrichment, echo=FALSE, eval=TRUE}
GO_enrichment <- enrichr(genes, dbs)
```

```{r figure title1, echo=FALSE, eval=TRUE}
print("GO_Biological_Process_2021")
```

```{r GO_Biological_Process_2021, echo=FALSE, eval=TRUE}
...
```{r figure title2, echo=FALSE, eval=TRUE}
print("GO_Cellular_Component_2021")
```

```{r GO_Cellular_Component_2021, echo=FALSE, eval=TRUE}
...
```{r figure title3, echo=FALSE, eval=TRUE}
print("GO_Molecular_Function_2021")
```

```{r GO_Molecular_Function_2021, echo=FALSE, eval=TRUE}
