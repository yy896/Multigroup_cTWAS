...
weights <- readRDS(system.file("extdata/project_data", "European.mashr_RefZ_TCGA.weights.RDS", package = "ctwas"))
ctwas_res <- readRDS(system.file("extdata/project_data", "European.combined_3_weights.ctwas_LD_allchrs.RDS", package = "ctwas"))
gwas_n <- 726828
finemap_res <- readRDS("~/Desktop/Prostate Cancer Project/European.combined_3_weights.with_LD.finemap_res.RDS")
susie_alpha_res <- readRDS("~/Desktop/Prostate Cancer Project/European.combined_3_weights.with_LD.susie_alpha_res.RDS")
