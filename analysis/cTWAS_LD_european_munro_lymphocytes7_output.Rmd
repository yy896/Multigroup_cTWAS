---
title: "Prostate Cancer ~ Munro 7 lymphocytes QTLs"
...
weights <- readRDS(system.file("extdata/project_data", "European.munro_lymphocytes7_weights.RDS", package = "ctwas"))
ctwas_res <- readRDS(system.file("extdata/project_data", "European.munro_lymphocytes7_weights.ctwas_noLD_allchrs.RDS", package = "ctwas"))
gwas_n <- 726828
finemap_res <- readRDS("~/Desktop/Prostate Cancer Project/European.munro_lymphocytes_weights.noLD.finemap_res.RDS")
susie_alpha_res <- readRDS("~/Desktop/Prostate Cancer Project/European.munro_lymphocytes_weights.noLD.susie_alpha_res.RDS")
...
weight_files <- c("/project2/xinhe/shared_data/multigroup_ctwas/weights/Munro_alt_polyA_PredictDB/apa_Lymphocytes.db",
                  "/project2/xinhe/shared_data/multigroup_ctwas/weights/Munro_alt_stability_PredictDB/Lymphocytes.db",
                  "/project2/xinhe/shared_data/multigroup_ctwas/weights/Munro_alt_tss_PredictDB/tss_Lymphocytes.db",
                  "/project2/xinhe/shared_data/multigroup_ctwas/weights/Munro_expression_PredictDB/expression_Lymphocytes.db",
                  "/project2/xinhe/shared_data/multigroup_ctwas/weights/Munro_isoform_PredictDB/isoform_Lymphocytes.db",
                  "/project2/xinhe/shared_data/multigroup_ctwas/weights/Munro_splicing_PredictDB/splicing_Lymphocytes.db",
                  "/project2/xinhe/shared_data/multigroup_ctwas/weights/Munro_stability_PredictDB/stability_Lymphocytes.db")
...
```{r echo=TRUE, eval=FALSE}
weights_lymphocytes_apaQTL <- preprocess_weights(weight_files[1],
                                              region_info,
...
weights_lymphocytes_astQTL <- preprocess_weights(weight_files[2],
                                              region_info,
                                              gwas_snp_ids = z_snp$id,
                                              snp_map = snp_map,
                                              LD_map = LD_map,
...
weights_lymphocytes_tssQTL <- preprocess_weights(weight_files[3],
                                              region_info,
                                              gwas_snp_ids = z_snp$id,
                                              snp_map = snp_map,
                                              LD_map = LD_map,
...
weights_lymphocytes_eQTL <- preprocess_weights(weight_files[4],
                                            region_info,
                                            gwas_snp_ids = z_snp$id,
                                            snp_map = snp_map,
                                            LD_map = LD_map,
...
weights_lymphocytes_isoQTL <- preprocess_weights(weight_files[5],
                                              region_info,
                                              gwas_snp_ids = z_snp$id,
                                              snp_map = snp_map,
                                              LD_map = LD_map,
...
weights_lymphocytes_sQTL <- preprocess_weights(weight_files[6],
                                            region_info,
                                            gwas_snp_ids = z_snp$id,
                                            snp_map = snp_map,
                                            LD_map = LD_map,
...
weights_lymphocytes_stQTL <- preprocess_weights(weight_files[7],
                                             region_info,
                                             gwas_snp_ids = z_snp$id,
                                             snp_map = snp_map,
                                             LD_map = LD_map,
...
weights <- c(
  weights_lymphocytes_apaQTL,
  weights_lymphocytes_astQTL,
  weights_lymphocytes_tssQTL,
  weights_lymphocytes_eQTL,
  weights_lymphocytes_isoQTL,
  weights_lymphocytes_sQTL,
  weights_lymphocytes_stQTL)
```
...
make_locusplot(finemap_res,
               region_id = "12_102571208_104454918",
               ens_db = ens_db,
               weights = weights,
               highlight_pip = 0.8,
               filter_protein_coding_genes = TRUE,
