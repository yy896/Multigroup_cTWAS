---
title: "cTWAS-European Lung//eQTL+sQTL"
author: "Nina Yifan Y."
date: "`r Sys.Date()`"
...
weights <- readRDS(system.file("extdata/project_data", "European.lung.weights.RDS", package = "ctwas"))
ctwas_res <- readRDS(system.file("extdata/project_data", "European.lung.ctwas_noLD_allchrs.RDS", package = "ctwas"))
gwas_n <- 726828
param <- ctwas_res$param
finemap_res <- readRDS("~/Desktop/Prostate Cancer Project/European.lung.finemap_res.RDS")
...
make_locusplot(finemap_res,
               region_id = "10_114661647_117764423",
               ens_db = ens_db,
               weights = weights,
               highlight_pip = 0.8,
               filter_protein_coding_genes = TRUE,
