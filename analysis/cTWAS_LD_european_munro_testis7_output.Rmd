---
title: "Prostate Cancer ~ Munro 7 testis QTLs"
...
weights <- readRDS(system.file("extdata/project_data", "European.munro_testis7_weights.RDS", package = "ctwas"))
ctwas_res <- readRDS(system.file("extdata/project_data", "European.munro_testis7_weights.ctwas_noLD_allchrs.RDS", package = "ctwas"))
gwas_n <- 726828
finemap_res <- readRDS("~/Desktop/Prostate Cancer Project/European.munro_testis_weights.noLD.finemap_res.RDS")
susie_alpha_res <- readRDS("~/Desktop/Prostate Cancer Project/European.munro_testis_weights.noLD.susie_alpha_res.RDS")
...
weight_files <- c("/project2/xinhe/shared_data/multigroup_ctwas/weights/Munro_alt_polyA_PredictDB/apa_Testis.db",
                  "/project2/xinhe/shared_data/multigroup_ctwas/weights/Munro_alt_stability_PredictDB/Testis.db",
                  "/project2/xinhe/shared_data/multigroup_ctwas/weights/Munro_alt_tss_PredictDB/tss_Testis.db",
                  "/project2/xinhe/shared_data/multigroup_ctwas/weights/Munro_expression_PredictDB/expression_Testis.db",
                  "/project2/xinhe/shared_data/multigroup_ctwas/weights/Munro_isoform_PredictDB/isoform_Testis.db",
                  "/project2/xinhe/shared_data/multigroup_ctwas/weights/Munro_splicing_PredictDB/splicing_Testis.db",
                  "/project2/xinhe/shared_data/multigroup_ctwas/weights/Munro_stability_PredictDB/stability_Testis.db")
...
```{r echo=TRUE, eval=FALSE}
weights_testis_apaQTL <- preprocess_weights(weight_files[1],
                                                  region_info,
...
weights_testis_astQTL <- preprocess_weights(weight_files[2],
                                             region_info,
                                             gwas_snp_ids = z_snp$id,
                                             snp_map = snp_map,
                                             LD_map = LD_map,
...
weights_testis_tssQTL <- preprocess_weights(weight_files[3],
                                              region_info,
                                              gwas_snp_ids = z_snp$id,
                                              snp_map = snp_map,
                                              LD_map = LD_map,
...
weights_testis_eQTL <- preprocess_weights(weight_files[4],
                                            region_info,
                                            gwas_snp_ids = z_snp$id,
                                            snp_map = snp_map,
                                            LD_map = LD_map,
...
weights_testis_isoQTL <- preprocess_weights(weight_files[5],
                                            region_info,
                                            gwas_snp_ids = z_snp$id,
                                            snp_map = snp_map,
                                            LD_map = LD_map,
...
weights_testis_sQTL <- preprocess_weights(weight_files[6],
                                             region_info,
                                             gwas_snp_ids = z_snp$id,
                                             snp_map = snp_map,
                                             LD_map = LD_map,
...
weights_testis_stQTL <- preprocess_weights(weight_files[7],
                                              region_info,
                                              gwas_snp_ids = z_snp$id,
                                              snp_map = snp_map,
                                              LD_map = LD_map,
...
weights <- c(
  weights_testis_apaQTL,
  weights_testis_astQTL,
  weights_testis_tssQTL,
  weights_testis_eQTL,
  weights_testis_isoQTL,
  weights_testis_sQTL,
  weights_testis_stQTL)
```
...
make_locusplot(finemap_res,
               region_id = "14_101067970_102545765",
               ens_db = ens_db,
               weights = weights,
               highlight_pip = 0.8,
               filter_protein_coding_genes = TRUE,
...
make_locusplot(finemap_res,
               region_id = "14_72422907_75978424",
               ens_db = ens_db,
               weights = weights,
               highlight_pip = 0.8,
               filter_protein_coding_genes = TRUE,
